...
public class Main extends ApplicationAdapter {
    ...
    private void logic(float delta){
        ...
        if(cd == 0){
            cd = 600;
            newattack(MathUtils.random(1, 128), MathUtils.random(1, 128), MathUtils.random(0, worldWidth), MathUtils.random(0, worldHeight), randomBool(), randomBool(), MathUtils.random(120, 240));
        }
